...
brain_phenotype_file = "C13Data/formatted_BP-Schaefer100.txt"
dist_mat_file = "Schaefer100_GeodesicParcelDistMat_midThickness_Left.txt"
nh = 10
pv = 70
npermutations = 1000
...
#SAcorrectedSpearmanBP.to_csv('SAcorrectedSpearmanBP-Schaefer100_1000perm.csv', index = False)
################################### FOR LP RATIO ##########################################

geneExpressionCSV = "Schaefer100_lh_expression.csv"
brain_phenotype_file = "C13Data/formatted_LP-Schaefer100.txt"
dist_mat_file = "Schaefer100_GeodesicParcelDistMat_midThickness_Left.txt"
nh = 10
pv = 70
npermutations = 1000
...
# Uncomment below to write to csv
#SAcorrectedSpearmanLP.to_csv('SAcorrectedSpearmanLP-Schaefer100_1000perm.csv', index = False)


################################### FOR LB RATIO ##########################################

geneExpressionCSV = "Schaefer100_lh_expression.csv"
brain_phenotype_file = "C13Data/formatted_LB-Schaefer100.txt"
dist_mat_file = "Schaefer100_GeodesicParcelDistMat_midThickness_Left.txt"
nh = 10
pv = 70
npermutations = 1000
...
# Uncomment below to write to csv
#SAcorrectedSpearmanLB.to_csv('SAcorrectedSpearmanLB-Schaefer100_1000perm.csv', index = False)
...
BPCorrectedPvals_Lake = pd.read_csv('SpatialAutocorrelationPermutation_CSV/SAcorrectedSpearmanBP-Schaefer100_1000perm.csv')
...
# CORRECTED PVALS = SA CORRECTED
# FDR CORRECTED PVALS = FDR CORRECTION OF SA CORRECTED PVALS
LPCorrectedPvals_Lake = pd.read_csv('SpatialAutocorrelationPermutation_CSV/SAcorrectedSpearmanLP-Schaefer100_1000perm.csv')
...
# CORRECTED PVALS = SA CORRECTED
# FDR CORRECTED PVALS = FDR CORRECTION OF SA CORRECTED PVALS
LBCorrectedPvals_Lake = pd.read_csv('SpatialAutocorrelationPermutation_CSV/SAcorrectedSpearmanLB-Schaefer100_1000perm.csv')
...
df_correctedLabelledPvalues_BP.to_csv('BP_Schaefer100Correlations_n40.csv',index=False)
df_correctedLabelledPvalues_LB.to_csv('LB_Schaefer100Correlations_n40.csv',index=False)
df_correctedLabelledPvalues_LP.to_csv('LP_Schaefer100Correlations_n40.csv',index=False)
